...
#' @author hlageek
#' @export
viz_pca_projection_field_2_3 <- function(pca_projection, axis_1 = "PC2", axis_2
                                         = "PC3", label_top = "Methods",
                                         label_bottom = "Materials", label_left
                                         = "Life", label_right = "Non-life", min_pubs = 5) {
  ...
  plot <- pca_projection |>
    ...
    geom_rect(xmin = -0.5, xmax = 0.5, ymin = ymin, ymax = -2.9, fill = "white", linewidth = 0.2, color = "black") +
    geom_rect(xmin = -0.5, xmax = 0.5, ymin = 2.9, ymax = ymax, fill = "white", linewidth = 0.2, color = "black") +
    geom_rect(xmin = xmin, xmax = -3.3, ymin = -0.5, ymax = 0.5, fill = "white", linewidth = 0.2, color = "black") +
    geom_rect(xmin = 3.55, xmax = xmax, ymin = -0.5, ymax = 0.5, fill = "white", linewidth = 0.2, color = "black") +
